...
public class Prenda {
    ...
    Prenda(TipoPrenda tipoSolicitado, MaterialException materialSolicitado, Trama tramaSolicitada, Color colorPrincipalSolicitado, Color colorSecundarioSolicitado) {
        ...
        if (materialSolicitado == null) {
            throw new SegundaIteracion.MaterialException("Debes seleccionar un tipo de material para la prenda");
        }
